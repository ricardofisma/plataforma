    ...
    _initializeOptions: function (t) {
      null == t && (t = []),
        (this.options = {
          ...
          displayWeekNumber:
            null != t.displayWeekNumber ? t.displayWeekNumber : !1,
          alwaysHalfDay: null != t.alwaysHalfDay ? t.alwaysHalfDay : !1,
          enableRangeSelection:
            null != t.enableRangeSelection ? t.enableRangeSelection : !1,
          disabledDays: t.disabledDays instanceof Array ? t.disabledDays : [],
          roundRangeLimits:
            null != t.roundRangeLimits ? t.roundRangeLimits : !1,
          ...
          style:
            ...
            "custom" == t.style
              ...
              : "border",
          enableContextMenu:
            null != t.enableContextMenu ? t.enableContextMenu : !1,
          contextMenuItems:
      ...
      for (var a = 0; 12 > a; a++) {
        ...
        for (
          var p = new Date(i.getTime()),
            g = new Date(this.options.startYear, a + 1, 0),
            f = n[this.options.language].weekStart;
          p.getDay() != f;
        ...
        for (; g >= p; ) {
          ...
          do {
            ...
            if ((y.addClass("day"), i > p)) y.addClass("old");
              ...
              if (
                (null != this.options.minDate && p < this.options.minDate) ||
                (null != this.options.maxDate && p > this.options.maxDate)
              )
                y.addClass("disabled");
              ...
              v.addClass("day-content"),
                ...
                this.options.customDayRenderer &&
                  this.options.customDayRenderer(v, p);
            }
        ...
        case "border":
          ...
          if (
            (1 == n.length
              ...
              : n.length <= 3
              ? (a = 2)
              : e.parent().css("box-shadow", "inset 0 -4px 0 0 black"),
            a > 0)
          ) {
            var s = "";
            for (var i in n)
              "" != s && (s += ","),
                (s +=
                  "inset 0 -" + (parseInt(i) + 1) * a + "px 0 0 " + n[i].color);
