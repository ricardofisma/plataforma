  ...
  Calendar.prototype = {
    ...
    _initializeOptions: function (opt) {
      ...
      this.options = {
        ...
        language:
          opt.language != null && dates[opt.language] != null
            ? opt.language
            : "en",
        ...
        dataSource:
          opt.dataSource instanceof Array != null ? opt.dataSource : [],
        style:
            ...
            if (currentDate < firstDate) {
              ...
              if (
                ...
                for (var d in this.options.disabledDays) {
                  if (
                    currentDate.getTime() ==
                    this.options.disabledDays[d].getTime()
                  ) {
                    cell.addClass("disabled");
                    break;
                  }
        ...
        this.element.find(".month-container").each(function () {
          ...
          if (
            ...
            for (var i in _this.options.dataSource) {
              if (
                !(_this.options.dataSource[i].startDate > lastDate) ||
                _this.options.dataSource[i].endDate < firstDate
              ) {
                ...
                .each(function () {
                  ...
                  if (
                    ...
                    for (var i in monthData) {
                      if (
                        monthData[i].startDate <= currentDate &&
    ...
    _applyEvents: function () {
      ...
      if (this.options.enableRangeSelection) {
        cells.mousedown(function (e) {
          if (e.which == 1) {
            ...
            if (
              _this.options.allowOverlap ||
              _this.getEvents(currentDate).length == 0
            ) {
        ...
        $(window).mouseup(function (e) {
          if (_this._mouseDown) {
            ...
            var minDate =
              _this._rangeStart < _this._rangeEnd
                ? _this._rangeStart
                : _this._rangeEnd;
            var maxDate =
      ...
      setInterval(function () {
        ...
        $(_this.element)
          ...
          .attr("class", monthContainerClass);
      }, 300);
    },
    ...
    _openContextMenu: function (elt) {
      ...
      if (contextMenu.children().length > 0) {
        var offset = 25;
        if (elt.offset().left > window.innerWidth - 200) offset = -200;
    ...
    getEvents: function (date) {
      ...
      if (this.options.dataSource && date) {
        for (var i in this.options.dataSource) {
          if (
            this.options.dataSource[i].startDate <= date &&
            this.options.dataSource[i].endDate >= date
          ) {
    ...
    setCustomDataSourceRenderer: function (customDataSourceRenderer) {
      this.options.customDataSourceRenderer = $.isFunction(
