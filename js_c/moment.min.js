...
!(function (a, b) {
  ...
  var Ad = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
    Bd = "Enero_Febrero_Marzo_abril_Mayo_Junio_Julio_Agosto_Setiembre_Octubre_Noviembre_Diciembre".split(
      "_"
    ),
    Cd = "Ene_Feb_Mar_Apr_May_Jun_Jul_Aug_Sept_Oct_Nov_Dec".split("_"),
    Dd = {};
  a.suppressDeprecationWarnings = !1;
  ...
  var Wd = "Domingo_Lunes_Martes_Miercoles_Jueves_Viernes_Sabado".split("_"),
    Xd = "Dom_Lun_Mar_Mie_Jue_Vie_Sab".split("_"),
