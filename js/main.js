$(document).ready(function () {
  ...
  $("#button-menu").click(function () {
    if ($("#button-menu").attr("class") == "fa fa-bars") {
      ...
      $("#button-menu").removeClass("fa fa-bars").addClass("fa fa-arrow-left"); // Agregamos el icono X
  ...
  // MOSTRANDO SUBMENU
  $(".itemw-submenuw a").click(function () {
    var positionMenuw = $(this).parent().attr("menu");
    console.log(positionMenuw);

    $(".itemw-submenuw[menu=" + positionMenuw + "] .submenuw").css({
      left: "0px",
    });
  });

  // OCULTANDO SUBMENU
  $(".go-backw").click(function () {
    $(this).parent().css({ left: "-320px" }); // Ocultamos el submenu
  });
});
