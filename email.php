...
if($chekar>0){
mysqli_query($link, "UPDATE  usuario SET confirmar='confirmado' WHERE email='".$_REQUEST['confirmar']."'");
}
}
...
http://localhost/email.php?confirmar='.$_REQUEST['email'];
...
<?php
//if($ww['usuario']!='confirmado' && !isset($_REQUEST['enviara'])){
if(isset($_REQUEST['confirmar'])){
